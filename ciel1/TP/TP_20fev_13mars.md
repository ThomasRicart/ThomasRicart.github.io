...
$$f\!\left(\frac{4}{3}\right) = \left(10 \times \frac{4}{3} + 20\right)e^{-0{,}3 \times \frac{4}{3}} = \left(\frac{40}{3} + \frac{60}{3}\right)e^{-0{,}4} = \frac{100}{3}\,e^{-0{,}4} \approx 33{,}33 \times 0{,}6703 \approx \mathbf{22{,}34 \text{ °C}}$$
